...
class Html extends  \GeCi\component\Component
{
	
	const FORM_REQUIRED = ' <span class="required">*</span>';
	 ...
	 * @return		string
	 */
	public function multiSelect($name = '', $options = array(), $selected = array(), $extra = '')
	{
	 ...
	 * @return		string
	 */
	public function listData($model,$key,$val)
	{
		$return=array();
